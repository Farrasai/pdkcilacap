...
class Ppid_setiapsaat_model extends CI_Model
{

    public $table = 'ppid_setiapsaat';
    public $id = 'id_setiapsaat';
    public $order = 'DESC';
...
/* End of file Ppid_setiapsaat_model.php */
/* Location: ./application/models/Ppid_setiapsaat_model.php */
