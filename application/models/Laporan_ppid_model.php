...
class Laporan_ppid_model extends CI_Model
{

    public $table = 'laporan_ppid';
...
/* End of file Laporan_ppid_model.php */
/* Location: ./application/models/Laporan_ppid_model.php */
