...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Ppid_berkala List</h2>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('ppid_berkala/read/'.$ppid_berkala->id_berkala),'Read'); 
				echo ' | '; 
				echo anchor(site_url('ppid_berkala/update/'.$ppid_berkala->id_berkala),'Update'); 
				echo ' | '; 
				echo anchor(site_url('ppid_berkala/delete/'.$ppid_berkala->id_berkala),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
