    ...
    <div class="row">
		...
		<th class="text-center">Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('user/read/'.$user->id_user),'Read','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('user/update/'.$user->id_user),'Update','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('user/delete/'.$user->id_user),'Delete','class="text-navy" onclick="javascript: return confirm(\'Yakin hapus data?\')"'); 
				?>
			</td>
		</tr>
