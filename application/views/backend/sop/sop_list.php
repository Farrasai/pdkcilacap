    ...
    <div class="row">
		...
		<th class="text-center">Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('sop/read/'.$sop->id_sop),'Read','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('sop/update/'.$sop->id_sop),'Update','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('sop/delete/'.$sop->id_sop),'Delete','class="text-navy" onclick="javascript: return confirm(\'Yakin hapus data?\')"'); 
				?>
			</td>
		</tr>
