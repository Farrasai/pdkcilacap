    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h2><b>List Ppid_setiapsaat</b></h2>
		...
		<th class="text-center">Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('ppid_setiapsaat/read/'.$ppid_setiapsaat->id_setiapsaat),'Read','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('ppid_setiapsaat/update/'.$ppid_setiapsaat->id_setiapsaat),'Update','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('ppid_setiapsaat/delete/'.$ppid_setiapsaat->id_setiapsaat),'Delete','class="text-navy" onclick="javascript: return confirm(\'Yakin hapus data?\')"'); 
				?>
			</td>
		</tr>
