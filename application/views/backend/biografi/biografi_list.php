    ...
    <div class="row">
		...
		<th class="text-center">Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('biografi/read/'.$biografi->id_biografi),'Read','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('biografi/update/'.$biografi->id_biografi),'Update','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('biografi/delete/'.$biografi->id_biografi),'Delete','class="text-navy" onclick="javascript: return confirm(\'Yakin hapus data?\')"'); 
				?>
			</td>
		</tr>
