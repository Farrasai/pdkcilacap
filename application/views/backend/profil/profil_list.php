    ...
    <div class="row">
		...
		<th class="text-center">Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('profil/read/'.$profil->id_profil),'Read','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('profil/update/'.$profil->id_profil),'Update','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('profil/delete/'.$profil->id_profil),'Delete','class="text-navy" onclick="javascript: return confirm(\'Yakin hapus data?\')"'); 
				?>
			</td>
		</tr>
