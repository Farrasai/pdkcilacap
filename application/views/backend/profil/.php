...
<html>
    ...
    <div class="row">
                ...
                <form action="<?php echo site_url('profil/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                          <button type="button" class="btn btn-success" onclick="lookup('<?php echo base_url()?>profil/lookup')" >Search</button>
                        </span>
                    </div>
                </form>
            </div>
		...
		<th class="text-center">Tugas Fungsi</th>
		<th class="text-center">Foto</th></tr>
            </thead>
			<tbody><?php
