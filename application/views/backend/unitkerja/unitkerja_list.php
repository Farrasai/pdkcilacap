    ...
    <div class="row">
		...
		<th class="text-center">Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('unitkerja/read/'.$unitkerja->id_unitkerja),'Read','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('unitkerja/update/'.$unitkerja->id_unitkerja),'Update','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('unitkerja/delete/'.$unitkerja->id_unitkerja),'Delete','class="text-navy" onclick="javascript: return confirm(\'Yakin hapus data?\')"'); 
				?>
			</td>
		</tr>
