...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Ppid_setiapsaat <?php echo $button ?></h2>
	    ...
	    <input type="hidden" name="id_setiapsaat" value="<?php echo $id_setiapsaat; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('ppid_setiapsaat') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>